			...
			gentity_t * activator)
{
	if (ent->spawnflags & 3) {	// looping sound toggles
		...
		if (ent->spawnflags & 8 && activator)
			G_AddEvent(activator, EV_GENERAL_SOUND,
				   ent->noise_index);
...
*/
void target_relay_use(gentity_t * self, gentity_t * other,
		      gentity_t * activator)
{
...
===============
*/
void target_rumble_use(gentity_t * self, gentity_t * other,
		       gentity_t * activator)
{
...
===============
*/
void target_alien_win_use(gentity_t * self, gentity_t * other,
			  gentity_t * activator)
{
...
===============
*/
void target_human_win_use(gentity_t * self, gentity_t * other,
			  gentity_t * activator)
{
...
void target_hurt_use(gentity_t * self, gentity_t * other, gentity_t * activator)
{
	...
	G_Damage(activator, self, self, NULL, NULL, self->damage, 0,
		 MOD_TRIGGER_HURT);
}
