...
static cvarTable_t gameCvarTable[] = {
	...
	// noset vars
	{ NULL, "gamename", GAME_VERSION, CVAR_SERVERINFO | CVAR_ROM, 0,
	 qfalse },
	...
	// change anytime vars
	{ &g_timelimit, "timelimit", "45",
	 CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue },
	{ &g_suddenDeathTime, "g_suddenDeathTime", "30",
	 CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue },
	{ &g_suddenDeathMode, "g_suddenDeathMode", "0",
	 CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue },
	{ &g_suddenDeath, "g_suddenDeath", "0",
	 CVAR_SERVERINFO | CVAR_NORESTART, 0, qtrue },

	{ &g_synchronousClients, "g_synchronousClients", "0", CVAR_SYSTEMINFO,
	 0, qfalse },

	{ &g_friendlyFire, "g_friendlyFire", "0",
	 CVAR_ARCHIVE | CVAR_SERVERINFO, 0, qtrue },
	{ &g_friendlyFireAliens, "g_friendlyFireAliens", "0", CVAR_ARCHIVE, 0,
	 qtrue },
	{ &g_friendlyFireHumans, "g_friendlyFireHumans", "0", CVAR_ARCHIVE, 0,
	 qtrue },
	{ &g_retribution, "g_retribution", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &g_friendlyBuildableFire, "g_friendlyBuildableFire", "0",
	 CVAR_ARCHIVE | CVAR_SERVERINFO, 0, qtrue },
	{ &g_friendlyFireMovementAttacks, "g_friendlyFireMovementAttacks", "1",
	 CVAR_ARCHIVE, 0, qtrue },
	{ &g_devmapNoGod, "g_devmapNoGod", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &g_devmapNoStructDmg, "g_devmapNoStructDmg", "0", CVAR_ARCHIVE, 0,
	 qtrue },
	...
	{ &g_needpass, "g_needpass", "0", CVAR_SERVERINFO | CVAR_ROM, 0,
	 qfalse },
	...
	{ &g_requireVoteReasons, "g_requireVoteReasons", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	...
	{ &g_suddenDeathVoteDelay, "g_suddenDeathVoteDelay", "180",
	 CVAR_ARCHIVE, 0, qfalse },
	{ &g_suddenDeathExtensionPercent, "g_suddenDeathExtensionPercent", "74",
	 CVAR_ARCHIVE, 0, qtrue },
	{ &g_suddenDeathExtensionTime, "g_suddenDeathExtensionTime", "5",
	 CVAR_ARCHIVE, 0, qtrue },
	{ &g_kickVotesPercent, "g_kickVotesPercent", "50", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_shuffleVotesPercent, "g_shuffleVotesPercent", "50", CVAR_ARCHIVE,
	 0, qfalse },
	...
	{ &g_customVotePercent, "g_customVotePercent", "50", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_mapVotesPercent, "g_mapVotesPercent", "50", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_extendVotesPercent, "g_extendVotesPercent", "74", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_extendVotesTime, "g_extendVotesTime", "10", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_extendVotesCount, "g_extendVotesCount", "2", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_mapRotationVote, "g_mapRotationVote", "15", CVAR_ARCHIVE, 0,
	 qfalse },
	...
	{ &g_newbieNumbering, "g_newbieNumbering", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_newbieNamePrefix, "g_newbieNamePrefix", "Newbie#", CVAR_ARCHIVE, 0,
	 qfalse },

	{ &g_smoothClients, "g_smoothClients", "1", 0, 0, qfalse },
	{ &g_outdatedClientMessage, "g_outdatedClientMessage", "", CVAR_ARCHIVE,
	 0, qfalse },
	{ &pmove_fixed, "pmove_fixed", "0", CVAR_SYSTEMINFO, 0, qfalse },
	{ &pmove_msec, "pmove_msec", "8", CVAR_SYSTEMINFO, 0, qfalse },

	{ &g_humanBuildPoints, "g_humanBuildPoints", DEFAULT_HUMAN_BUILDPOINTS,
	 CVAR_SERVERINFO, 0, qfalse },
	{ &g_alienBuildPoints, "g_alienBuildPoints", DEFAULT_ALIEN_BUILDPOINTS,
	 CVAR_SERVERINFO, 0, qfalse },
	{ &g_humanStage, "g_humanStage", "0", 0, 0, qfalse },
	{ &g_humanKills, "g_humanKills", "0", 0, 0, qfalse },
	{ &g_humanMaxStage, "g_humanMaxStage", DEFAULT_HUMAN_MAX_STAGE, 0, 0,
	 qfalse },
	{ &g_humanStage2Threshold, "g_humanStage2Threshold",
	 DEFAULT_HUMAN_STAGE2_THRESH, 0, 0, qfalse },
	{ &g_humanStage3Threshold, "g_humanStage3Threshold",
	 DEFAULT_HUMAN_STAGE3_THRESH, 0, 0, qfalse },
	{ &g_alienStage, "g_alienStage", "0", 0, 0, qfalse },
	{ &g_alienKills, "g_alienKills", "0", 0, 0, qfalse },
	{ &g_alienMaxStage, "g_alienMaxStage", DEFAULT_ALIEN_MAX_STAGE, 0, 0,
	 qfalse },
	{ &g_alienStage2Threshold, "g_alienStage2Threshold",
	 DEFAULT_ALIEN_STAGE2_THRESH, 0, 0, qfalse },
	{ &g_alienStage3Threshold, "g_alienStage3Threshold",
	 DEFAULT_ALIEN_STAGE3_THRESH, 0, 0, qfalse },

	{ &g_teamImbalanceWarnings, "g_teamImbalanceWarnings", "30",
	 CVAR_ARCHIVE, 0, qfalse },

	{ &g_unlagged, "g_unlagged", "1", CVAR_SERVERINFO | CVAR_ARCHIVE, 0,
	 qtrue },

	{ &g_disabledEquipment, "g_disabledEquipment", "", CVAR_ROM, 0,
	 qfalse },
	{ &g_disabledClasses, "g_disabledClasses", "", CVAR_ROM, 0, qfalse },
	{ &g_disabledBuildables, "g_disabledBuildables", "", CVAR_ROM, 0,
	 qfalse },

	{ &g_chatTeamPrefix, "g_chatTeamPrefix", "1", CVAR_ARCHIVE },
	{ &g_actionPrefix, "g_actionPrefix", "* ", CVAR_ARCHIVE, 0, qfalse },
	{ &g_floodMaxDemerits, "g_floodMaxDemerits", "5000", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_floodMinTime, "g_floodMinTime", "2000", CVAR_ARCHIVE, 0, qfalse },
	{ &g_spamTime, "g_spamTime", "2", CVAR_ARCHIVE, 0, qfalse },

	{ &g_markDeconstruct, "g_markDeconstruct", "0", CVAR_ARCHIVE, 0,
	 qtrue },
	{ &g_markDeconstructMode, "g_markDeconstructMode", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_deconDead, "g_deconDead", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &g_stackableBuildings, "g_stackableBuildings", "0", CVAR_ARCHIVE, 0,
	 qtrue },
	{ &g_guidlessBuildersAllowed, "g_guidlessBuildersAllowed", "1",
	 CVAR_ARCHIVE, 0, qtrue },
	...
	{ &g_initialMapRotation, "g_initialMapRotation", "", CVAR_ARCHIVE, 0,
	 qfalse },
	...
	{ &g_adminNameProtect, "g_adminNameProtect", "1", CVAR_ARCHIVE, 0,
	 qfalse },
	...
	{ &g_adminSuperStealth, "g_adminSuperStealth", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_minLevelToJoinTeam, "g_minLevelToJoinTeam", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_minDeconLevel, "g_minDeconLevel", "0", CVAR_ARCHIVE, 0, qfalse },
	{ &g_minDeconAffectsMark, "g_minDeconAffectsMark", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_forceAutoSelect, "g_forceAutoSelect", "0", CVAR_ARCHIVE, 0,
	 qtrue },
	{ &g_adminExpireTime, "g_adminExpireTime", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_preventRagequit, "g_preventRagequit", "0", CVAR_ARCHIVE, 0,
	 qtrue },

	{ &g_privateMessages, "g_privateMessages", "1", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_fullIgnore, "g_fullIgnore", "1", CVAR_ARCHIVE, 0, qtrue },
	{ &g_decolourLogfiles, "g_decolourLogfiles", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_buildLogMaxLength, "g_buildLogMaxLength", "50", CVAR_ARCHIVE, 0,
	 qfalse },
	...
	{ &g_publicSayadmins, "g_publicSayadmins", "1", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_minLevelToSpecMM1, "g_minLevelToSpecMM1", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	...
	{ &g_allowShare, "g_allowShare", "0", CVAR_ARCHIVE | CVAR_SERVERINFO, 0,
	 qfalse },
	{ &g_creditOverflow, "g_creditOverflow", "0",
	 CVAR_ARCHIVE | CVAR_SERVERINFO, 0, qfalse },
	{ &g_banNotice, "g_banNotice", "", CVAR_ARCHIVE, 0, qfalse },

	{ &mod_jetpackFuel, "mod_jetpackFuel", "0", CVAR_ARCHIVE, 0, qtrue },
	{ &mod_jetpackConsume, "mod_jetpackConsume", "2", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &mod_jetpackRegen, "mod_jetpackRegen", "3", CVAR_ARCHIVE, 0, qfalse },

	{ &g_teamKillThreshold, "g_teamKillThreshold", "0", CVAR_ARCHIVE, 0,
	 qfalse },

	{ &g_aimbotAdvertBan, "g_aimbotAdvertBan", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_aimbotAdvertBanTime, "g_aimbotAdvertBanTime", "0", CVAR_ARCHIVE, 0,
	 qfalse },
	{ &g_aimbotAdvertBanReason, "g_aimbotAdvertBanReason",
	 "AUTOBAN: AIMBOT", CVAR_ARCHIVE, 0, qfalse },

	{ &g_Bubbles, "g_Bubbles", "1", CVAR_ARCHIVE, 0, qfalse },
	{ &g_scrimMode, "g_scrimMode", "0", CVAR_ARCHIVE, 0, qfalse },
	{ &g_gradualFreeFunds, "g_gradualFreeFunds", "2", CVAR_ARCHIVE, 0,
	 qtrue },
	{ &g_bleedingSpree, "g_bleedingSpree", "0", CVAR_ARCHIVE, 0, qfalse },
	{ &g_gradualFreeFunds, "g_gradualFreeFunds", "2", CVAR_ARCHIVE, 0,
	 qtrue },
	{ &g_schachtmeisterClearThreshold, "g_schachtmeisterClearThreshold",
	 "-10", CVAR_ARCHIVE, 0, qfalse },
	{ &g_schachtmeisterAutobahnThreshold,
	 "g_schachtmeisterAutobahnThreshold", "-30", CVAR_ARCHIVE, 0, qfalse },
	{ &g_schachtmeisterAutobahnMessage, "g_schachtmeisterAutobahnMessage",
	 "Your host is blacklisted.", CVAR_ARCHIVE, 0, qfalse },
	{ &g_adminAutobahnNotify, "g_adminAutobahnNotify", "1", CVAR_ARCHIVE, 0,
	 qfalse },
	...
	{ &g_grangerBombTime, "g_grangerBombTimeMod", "3", CVAR_ARCHIVE, 0, qtrue },

	{ &g_debugRewards, "g_debugRewards", "0", CVAR_ARCHIVE, 0, qfalse },
	{ &g_sdDefenderMaxPenalty, "g_sdDefenderMaxPenalty", "45", CVAR_ARCHIVE,
	 0, qtrue },
	{ &g_sdDefenderForgiveness, "g_sdDefenderForgiveness", "7",
	 CVAR_ARCHIVE, 0, qtrue },
	{ &g_sdDefenderPenaltyIncrement, "g_sdDefenderPenaltyIncrement", "3",
	 CVAR_ARCHIVE, 0, qfalse },
	...
	if (g_logFile.string[0]) {
		...
		if (!level.logFile)
			...
			G_LogPrintf("RealTime: %04i/%02i/%02i %02i:%02i:%02i\n",
				    qt.tm_year + 1900, qt.tm_mon + 1,
				    qt.tm_mday, qt.tm_hour, qt.tm_min,
				    qt.tm_sec);
	...
	if (G_GetSpawnQueueLength(sq)) {
		do {
			if (sq->clients[i] == clientNum) {
				...
				do {
					sq->clients[i] =
					    sq->clients[QUEUE_PLUS1(i)];

					i = QUEUE_PLUS1(i);
				} while (i != QUEUE_PLUS1(sq->back));

				sq->back = QUEUE_MINUS1(sq->back);
				g_entities[clientNum].client->ps.pm_flags &=
				    ~PMF_QUEUED;
...
void G_SpawnClients(pTeam_t team)
{
	...
	if (g_doWarmup.integer
	    && (g_warmupMode.integer == 1 || g_warmupMode.integer == 2)
...
void G_CalculateBuildPoints(void)
{
		...
		if (g_suddenDeath.integer || G_TimeTilSuddenDeath() <= 0)	//Conditions to enter SD
		{
			...
			if (level.suddenDeathWarning < TW_PASSED) {
				trap_SendServerCommand(-1,
						       "cp \"Sudden Death!\"");
				G_LogPrintf
				    ("Beginning Sudden Death (Mode %d)\n",
				     g_suddenDeathMode.integer);
				localHTP = 0;
				localATP = 0;

				if (g_suddenDeathMode.integer ==
				    SDMODE_SELECTIVE) {
					for (i = 1, ent = g_entities + i;
	...
	for (i = 1, ent = g_entities + i; i < level.num_entities; i++, ent++) {
		...
		if (buildable != BA_NONE) {
			if (buildable == BA_H_REACTOR && ent->spawned
			    && ent->health > 0)
				level.reactorPresent = qtrue;

			if (buildable == BA_A_OVERMIND && ent->spawned
			    && ent->health > 0)
				level.overmindPresent = qtrue;

			if (!g_suddenDeath.integer
			    || BG_FindReplaceableTestForBuildable(buildable)) {
				if (BG_FindTeamForBuildable(buildable) ==
				    BIT_HUMANS) {
	...
	{
		float alienPlayerCountMod =
		    level.averageNumAlienClients / PLAYER_COUNT_MOD;
		float humanPlayerCountMod =
		    level.averageNumHumanClients / PLAYER_COUNT_MOD;
		...
		if (g_alienStage.integer == S1 && g_alienMaxStage.integer > S1)
			alienNextStageThreshold =
			    (int)(ceil
				  ((float)g_alienStage2Threshold.integer *
				   alienPlayerCountMod));
		else if (g_alienStage.integer == S2
			 && g_alienMaxStage.integer > S2)
			alienNextStageThreshold =
			    (int)(ceil
				  ((float)g_alienStage3Threshold.integer *
				   alienPlayerCountMod));
		else
		...
		if (g_humanStage.integer == S1 && g_humanMaxStage.integer > S1)
			humanNextStageThreshold =
			    (int)(ceil
				  ((float)g_humanStage2Threshold.integer *
				   humanPlayerCountMod));
		else if (g_humanStage.integer == S2
			 && g_humanMaxStage.integer > S2)
			humanNextStageThreshold =
			    (int)(ceil
				  ((float)g_humanStage3Threshold.integer *
				   humanPlayerCountMod));
		else
...
void G_CalculateStages(void)
{
	...
	if (g_alienKills.integer >=
	    (int)(ceil
		  ((float)g_alienStage2Threshold.integer * alienPlayerCountMod))
	...
	if (g_alienKills.integer >=
	    (int)(ceil
		  ((float)g_alienStage3Threshold.integer * alienPlayerCountMod))
	...
	if (g_humanKills.integer >=
	    (int)(ceil
		  ((float)g_humanStage2Threshold.integer * humanPlayerCountMod))
	...
	if (g_humanKills.integer >=
	    (int)(ceil
		  ((float)g_humanStage3Threshold.integer * humanPlayerCountMod))
	...
	for (i = 0; i < level.maxclients; i++) {
		...
		if (level.clients[i].pers.connected != CON_DISCONNECTED) {
			...
			if (level.clients[i].pers.teamSelection != PTE_NONE) {
				...
				if (level.clients[i].pers.teamSelection ==
				    PTE_ALIENS) {
					level.numAlienClients++;
					if (level.clients[i].sess.sessionTeam !=
					    TEAM_SPECTATOR)
						level.numLiveAlienClients++;
				} else if (level.clients[i].pers.
					   teamSelection == PTE_HUMANS) {
...
void FindIntermissionPoint(void)
{
	...
	if (!ent) {		// the map creator forgot to put in an intermission point...
		G_SelectSpawnPoint(vec3_origin, level.intermission_origin,
...
void BeginIntermission(void)
{
	...
	if (g_nextMap.string[0]) {
		trap_SendServerCommand(-1,
				       va
				       ("print \"next map has been set to %s^7%s\n\"",
					g_nextMap.string,
					(G_CheckMapRotationVote())?
					", voting will be skipped" : ""));
	}
}
...
void ExitLevel(void)
{
	...
	if (level.mapRotationVoteTime) {
		if (level.time < level.mapRotationVoteTime &&
		   ...
		   G_CheckMapRotationVote() && !g_nextMap.string[0]) {
...
void QDECL G_AdminsPrintf(const char *fmt, ...)
{
	...
	for (j = 0; j < level.maxclients; j++) {
		...
		if (G_admin_permission(tempent, ADMF_ADMINCHAT) &&
			...
			trap_SendServerCommand(tempent - g_entities,
					       va
...
void G_SendGameStat(pTeam_t team)
{
	...
	for (i = 0; i < level.numConnectedClients; i++) {
		...
		Com_sprintf(entry, MAX_STRING_CHARS,
			    ...
			    ping, (level.time - cl->pers.enterTime) / 60000);
...
void CheckExitRules(void)
{
	...
	if (g_timelimit.integer) {
		if (level.time - level.startTime >= g_timelimit.integer * 60000) {
			...
			return;
		} else if (level.time - level.startTime >=
			   (g_timelimit.integer - 5) * 60000
			   && level.timelimitWarning < TW_IMMINENT) {
			trap_SendServerCommand(-1,
					       "cp \"5 minutes remaining!\"");
			level.timelimitWarning = TW_IMMINENT;
		} else if (level.time - level.startTime >=
			   (g_timelimit.integer - 1) * 60000
			   && level.timelimitWarning < TW_PASSED) {
			trap_SendServerCommand(-1,
					       "cp \"1 minute remaining!\"");
			level.timelimitWarning = TW_PASSED;
		}
	}
...
void CheckVote(void)
{
	...
	if (level.voteExecuteTime && level.voteExecuteTime < level.time) {
		...
		if (!Q_stricmp(level.voteString, "suddendeath")) {
			level.suddenDeathBeginTime =
			    level.time +
			    (1000 * g_suddenDeathVoteDelay.integer) -
			    level.startTime;
		...
		if (!Q_stricmp(level.voteString, "delay_sudden_death")) {
			...
			if (level.suddenDeath) {
				trap_SendServerCommand(-1,
						       "print \"^ASudden Death has now begun so this vote is null and void.\n");
			} else {
				level.suddenDeathBeginTime =
				    level.suddenDeathBeginTime +
				    (60000 *
				...
				trap_SendServerCommand(-1,
						       va
						       ("cp \"Sudden Death has been delayed by ^3%i^7 minutes\n"
							"and will now be at ^3%02i:00^7\n\"",
							g_suddenDeathExtensionTime.
							integer,
							level.
							suddenDeathBeginTime /
							60000));
				trap_SendServerCommand(-1,
						       va
						       ("print \"Sudden Death has been delayed by ^3%i^7 minutes "
							"and will now be at ^3%02i:00^7\n\"",
							g_suddenDeathExtensionTime.
							integer,
							level.
	...
	if ((level.time - level.voteTime >= VOTE_TIME) ||
		...
		if (voteYesPercent > votePassThreshold || level.voteNo == 0) {
			...
			trap_SendServerCommand(-1,
						...
						turnoutCol, turnout));
			G_LogPrintf
			    ("Vote: Vote passed (%d - %d), turnout: %i%%\n",
			...
			trap_SendServerCommand(-1,
						...
						turnoutCol, turnout));
			G_LogPrintf
			    ("Vote: Vote failed (%d - %d), turnout: %i%%\n",
			     level.voteYes, level.voteNo, turnout);
		}
	} else {
					  ...
					  ((double)votePassThreshold / 100.0)))
		{
			...
			G_LogPrintf
			    ("Vote: Vote passed (%d - %d), turnout: %i%%\n",
			     level.voteYes, level.voteNo, turnout);
			level.voteExecuteTime = level.time + 3000;
		} else if (level.voteNo >
			   (int)((double)level.numConnectedClients *
				 ((double)(100.0 - votePassThreshold) /
				  100.0))) {
			// same behavior as a timeout
			trap_SendServerCommand(-1,
					       va
...
void CheckTeamVote(int team)
{
	...
	if (level.time - level.teamVoteTime[cs_offset] >= VOTE_TIME) {
		if (level.teamVoteYes[cs_offset] > level.teamVoteNo[cs_offset]
		    && level.teamVoteYes[cs_offset] >= 2) {
			// execute the command, then remove the vote
			trap_SendServerCommand(-1,
					       va
					       ("print \"Team vote ^Zpassed ^7(^ZYes: ^7%d | ^ANo: ^7%d)\n\"",
						level.teamVoteYes[cs_offset],
						level.teamVoteNo[cs_offset]));
			trap_SendConsoleCommand(EXEC_APPEND,
						va("%s\n",
						   level.
						   teamVoteString[cs_offset]));
		} else {
			trap_SendServerCommand(-1,
					       va
					       ("print \"Team vote ^Afailed ^7(^ZYes: ^7%d | ^ANo: ^7%d)\n\"",
						level.teamVoteYes[cs_offset],
						level.teamVoteNo[cs_offset]));
	...
	if (g_welcomeMsgTime.integer && g_welcomeMsg.string[0]) {
		...
		for (i = 0; i < level.maxclients; i++) {
			...
			if (level.time - level.clients[i].pers.enterTime < wt) {
				if (buffer[0] == '\0') {
					Q_strncpyz(buffer, g_welcomeMsg.string,
						   sizeof(buffer));
...
void CheckCountdown(void)
{
	...
	if (timeleft > 0)
		trap_SendServerCommand(-1,
				       va
				       ("cp \"^1Warmup Time:^7\n^%i----- ^7%i ^%i-----\"",
					timeleft % 7, timeleft, timeleft % 7));
	else if (timeleft == 0) {
		...
		if (g_suddenDeathTime.integer > 0)
			trap_SendServerCommand(-1,
					       va
					       ("print \"^7Sudden Death will be at ^3%02i:00^7\n",
						g_suddenDeathTime.integer));

		if (g_timelimit.integer > 0)
			trap_SendServerCommand(-1,
					       va
					       ("print \"^7The timelimit is at ^3%02i:00^7\n",
						g_timelimit.integer));
	}
}
...
void CheckCvars(void)
{
	...
	if (g_markDeconstruct.modificationCount != lastMarkDeconModCount) {
		...
		for (i = 1, ent = g_entities + i; i < level.num_entities;
		     i++, ent++) {
			if (!ent->inuse)
				continue;
