...
===============
*/
void trigger_teleporter_use(gentity_t * ent, gentity_t * other,
			    gentity_t * activator)
{
...
void hurt_touch(gentity_t * self, gentity_t * other, trace_t * trace)
{
	...
	G_Damage(other, self, self, NULL, NULL, self->damage, dflags,
		 MOD_TRIGGER_HURT);
}
...
void func_timer_think(gentity_t * self)
{
	...
	self->nextthink =
	    level.time + 1000 * (self->wait + crandom() * self->random);
}
...
===============
*/
void trigger_stage_use(gentity_t * self, gentity_t * other,
		       gentity_t * activator)
{
...
void trigger_buildable_trigger(gentity_t * self, gentity_t * activator)
{
	...
	if (self->wait > 0) {
		...
		self->nextthink =
		    level.time + (self->wait + self->random * crandom()) * 1000;
	} else {
		// we can't just remove (self) here, because this is a touch function
		// called while looping through area links...
		self->touch = 0;
...
===============
*/
void trigger_buildable_touch(gentity_t * ent, gentity_t * other,
			     trace_t * trace)
{
...
===============
*/
void trigger_buildable_use(gentity_t * ent, gentity_t * other,
			   gentity_t * activator)
{
	ent->s.eFlags ^= EF_NODRAW;
}
...
===============
*/
void trigger_class_use(gentity_t * ent, gentity_t * other,
		       gentity_t * activator)
{
	ent->s.eFlags ^= EF_NODRAW;
}
...
===============
*/
void trigger_equipment_touch(gentity_t * ent, gentity_t * other,
			     trace_t * trace)
{
	//only triggered by clients
	if (!other->client)
...
===============
*/
void trigger_equipment_use(gentity_t * ent, gentity_t * other,
			   gentity_t * activator)
{
	ent->s.eFlags ^= EF_NODRAW;
}
...
===============
*/
void trigger_gravity_use(gentity_t * ent, gentity_t * other,
			 gentity_t * activator)
{
	if (ent->r.linked)
...
===============
*/
void trigger_heal_use(gentity_t * self, gentity_t * other,
		      gentity_t * activator)
{
	if (self->r.linked)
		trap_UnlinkEntity(self);
...
void trigger_ammo_touch(gentity_t * self, gentity_t * other, trace_t * trace)
{
	...
	if (BG_FindUsesEnergyForWeapon(other->client->ps.weapon)
	    && self->spawnflags & 2)
		return;
